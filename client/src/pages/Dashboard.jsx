  ...
  return (
    <div>
      <div className='max-w-7xl mx-auto px-4 py-8'>
        ...
        {/* --- Create Resume Modal --- */}
        {showCreateResume && (
          <form onSubmit={createResume} className='fixed inset-0 bg-black/70 backdrop-blur-sm z-10 flex items-center justify-center'>
            <div onClick={e => e.stopPropagation()} className='relative bg-white border shadow-md rounded-lg w-full max-w-sm p-6'>
              ...
              <input  
                ...
                className='w-full px-4 py-2 mb-4 border border-slate-300 rounded focus:outline-none focus:ring-2 focus:ring-green-600' 
                required 
              />
              <button className='w-full py-2 bg-green-600 text-white rounded hover:bg-green-700 transition-colors'>Create Resume</button>

              {/* ✅ FIX: Corrected position and class */}
              <XIcon 
        ...
        {/* --- Upload Resume Modal --- */}
        {showUploadResume && (
          <form onSubmit={uploadResume} className='fixed inset-0 bg-black/70 backdrop-blur-sm z-10 flex items-center justify-center'>
            <div onClick={e => e.stopPropagation()} className='relative bg-white border shadow-md rounded-lg w-full max-w-sm p-6'>
        ...
        {/* --- Edit Title Modal --- */}
        {editResumeId && (
          <form onSubmit={editTitle} className='fixed inset-0 bg-black/70 backdrop-blur-sm z-10 flex items-center justify-center'>
            <div onClick={e => e.stopPropagation()} className='relative bg-white border shadow-md rounded-lg w-full max-w-sm p-6'>
              ...
              {/* ✅ FIX: correct close button logic */}
              <XIcon 
                className='absolute top-3 right-3 text-slate-400 hover:text-slate-600 cursor-pointer transition-colors' 
