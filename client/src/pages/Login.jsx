  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-50">
      <form
        ...
        className="sm:w-[350px] w-full text-center border border-gray-300/60 rounded-2xl px-8 py-8 bg-white shadow-md"
      >
        ...
        <p
          ...
          className="text-gray-500 text-sm mt-3 mb-3 cursor-pointer"
        >
          {state === "login"
