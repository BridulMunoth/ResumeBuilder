...
const SpacingControls = ({ spacing, layout, onChange, template }) => {
        ...
        <div className="flex gap-4">
          <button
            ...
            className={`flex flex-col items-center justify-center p-4 rounded-lg border-2 transition-all w-28 h-20 ${
              layout.columns === 1 || template === "classic"
          ...
          <button
            onClick={() => template !== "classic" && handleLayoutChange(2)}
      ...
      <section className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            onChange={(e) =>
              handleChange("margin_horizontal", Number(e.target.value))
            }
            className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-blue-600"
          />
        </div>
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            onChange={(e) =>
              handleChange("margin_vertical", Number(e.target.value))
            }
            className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-blue-600"
          />
        </div>
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            onChange={(e) =>
              handleChange("section_spacing", Number(e.target.value))
            }
            className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-blue-600"
          />
        </div>
