      ...
      <div className="flex items-start justify-between gap-4 rounded-2xl bg-white border border-gray-200 p-5">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-yellow-200 bg-yellow-50 text-yellow-600 shadow-sm hover:bg-yellow-100"
          >
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-emerald-50 border border-emerald-200 px-5 py-2.5 text-sm font-medium text-emerald-700 hover:bg-emerald-100 transition shadow-sm"
          >
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <textarea
                      ...
                      placeholder={
                        "e.g., Increased conversion by 18%\nReduced load time by 30%"
                      }
