...
const TimelineItem = ({
  ...
  return (
    <div
      className="relative p-4 pb-4 last:pb-0 border rounded-md shadow-sm"
    ...
    >
      ...
      <div className="pl-4 flex flex-wrap items-baseline justify-between gap-x-3 gap-y-0.5 mb-1">
        <h3
      ...
      <div className="pl-4 flex flex-wrap items-baseline justify-between gap-x-2 mb-2">
        <div
      ...
      <div
        className="pl-4 flex flex-wrap items-center gap-2 mb-2"
        style={{ fontSize: "0.85em" }}
      >
        {showGrade && grade && (
      ...
      {item.description && (
        <div className="pl-4 text-gray-700 whitespace-pre-line leading-relaxed mb-2 opacity-90">
          {item.description}
        </div>
      )}

      {achievements.length > 0 && (
        <ul className="pl-4 flex flex-wrap gap-x-4 gap-y-1 my-2 list-none p-0">
      ...
      {tech.length > 0 && (
        <div className="pl-4 flex flex-wrap gap-1.5 mt-2">
          {tech.map((t, i) => (
            <span
              key={i}
...
const ProfessionalTemplate = ({ data, formatting = {}, accentColor }) => {
  ...
  // If two-column and user wants personal block in sidebar, prepare it
  ...
  const PersonalBlock = () => (
    <div className="space-y-3">
      ...
      <div
        className={cx(
          "text-sm",
          personalArrangement === "grid" && "grid grid-cols-1 gap-2",
          personalArrangement === "inline" && "flex flex-wrap gap-x-4 gap-y-2",
    ...
    >
      ...
      <div style={{ padding: contentPadding }}>
        ...
        {!movePersonalToSidebar && (
          ...
          >
            {/* Intentionally no image in ProfessionalTemplate */}
