      ...
      <div>
        ...
        <div className="flex gap-3">
          {["hidden", "left", "center", "right"].map((align) => {
            ...
            const isNonImage = NON_IMAGE_TEMPLATES.includes(template);
            const isDisabled =
              isNonImage ||
              (template === "classic" && !["hidden", "center"].includes(align));
      ...
      <div>
        ...
        <div className="flex gap-3 flex-wrap">
          {[
            ...
            const isDisabled =
              template === "classic" &&
              ["soft", "diamond", "glow"].includes(style);
            return (
              <button
                key={style}
