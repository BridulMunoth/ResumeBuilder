...
export const uploadResume = async (req, res) => {
    try {
            ...
            messages: [
                {
                    role: "system",
                    content:
                        `You are an expert AI Agent to extract data from resume. Provide the data in the following JSON format without any additional text before or after it.
        ...
        try {
            ...
            return res.status(400).json({ message: "Failed to parse resume data." });
        }
